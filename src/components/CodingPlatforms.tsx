  ...
  const platforms = [
    {
      ...
      achievements: 'Rank 1 in Institute (VCE), 375+ Days Streak'
    },
    {
      name: 'CodeChef',
      username: 'rithwik007',
      url: 'https://www.codechef.com/users/rithwik007',
      achievements: '315+ Days Streak'
    },
    {
      name: 'LeetCode',
      username: 'd_rithwik',
    ...
    },
    {
      ...
      achievements: 'Level 7 in Code 360, Rank 1 in Institute (VCE)'
    },
    {
      name: 'InterviewBit',
      username: 'rithwik-d',
      url: 'https://www.interviewbit.com/profile/rithwik-d/',
      achievements: 'Rank 1 in Institute (VCE)'
    }
  ];
